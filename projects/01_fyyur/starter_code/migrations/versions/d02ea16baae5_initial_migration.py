...
Revision ID: d02ea16baae5
Revises: 
Create Date: 2021-06-23 03:07:53.847212
...
def downgrade():
    ...
    sa.Column('websit_link', sa.VARCHAR(length=120), autoincrement=False, nullable=True),
    sa.Column('venues_Art', sa.BOOLEAN(), autoincrement=False, nullable=True),
